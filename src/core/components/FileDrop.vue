    ...
    >
      <slot>
        <div class="text-gray-600">
          ...
          <a class="text-primary-500 cursor-pointer font-bold hover:underline" @click="triggerUpload">browse</a> your
          files
          <input ref="fileUpload" multiple type="file" class="hidden" @change.prevent="selectFiles" />
        </div>
        <div class="text-sm italic mt-2">(Up to 5 Files & File size should be &lt; 5mb)</div>
      </slot>
    </div>
